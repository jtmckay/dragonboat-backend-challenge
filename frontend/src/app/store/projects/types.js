...
export const MOVE_PROJECT_FULFILLED = "MOVE_PROJECT_FULFILLED";
export const MOVE_PROJECT_REJECTED = "MOVE_PROJECT_REJECTED";
export const MOVE_PROJECT_PENDING = "MOVE_PROJECT_PENDING";
